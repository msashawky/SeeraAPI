 ...
 OrganizationWebsite $organizationWebsite, NewsLetter $newsLetter, InfoWebsiteContent $infoWebsite)
    ...
    public function validateUpdateWebsite(Request $request){
        return $this->apiValidation($request, [
            ...
            'logo' => 'required',
            'favicon' => 'required',
            'about_us_ar' => 'required|min:5|max:1000',
            'about_us_en' => 'required|min:5|max:1000',
            'address_ar' => 'required|min:5|max:1000',
            'address_en' => 'required|min:5|max:1000',
            'terms_and_conditions_ar' => 'required|min:5|max:1000',
            'terms_and_conditions_en' => 'required|min:5|max:1000',
            'privacy_policy_ar' => 'required|min:5|max:1000',
            'privacy_policy_en' => 'required|min:5|max:1000',
            'phone_number' => 'required',
